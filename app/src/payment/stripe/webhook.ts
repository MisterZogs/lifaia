...
async function handleInvoicePaid(
  ...
  switch (paymentPlanId) {
    case PaymentPlanId.Premium:
    case PaymentPlanId.PremiumAnnuel:
...
async function handleCustomerSubscriptionUpdated(
  ...
  if (subscription.cancel_at_period_end && user.email) {
    await emailSender.send({
      to: user.email,
      subject: "Votre abonnement Lifaia Premium sera résilié",
      text: "Votre abonnement Premium sera actif jusqu'à la fin de la période en cours. Vous pouvez le réactiver à tout moment depuis votre espace abonné.",
      html: `<p>Votre abonnement <strong>Lifaia Premium</strong> sera actif jusqu'à la fin de la période en cours.</p>
<p>Vous pouvez le réactiver à tout moment depuis votre <a href="https://lifaia.com/pricing">espace abonné</a>.</p>
